...
class GUIForSelectingAFolder():
    ...
    def __init__(self):
        ...
        self.path = r'C:\Users\Horace.000\eclipse-workspace\Python_Project_6_Online_Courses\00_ALL\Files\App\Rename_Randomly_All_Files_in_a_Folder\Folder_with_Files'
    ...
    def method_for_button_START(self): 
        ...
        AllFilesFromAFolder.rename_files(self, self.path)
        print(f'ALL Files renamed!!!')
        AllFilesFromAFolder.all_files_and_subfolders_in_a_folder(self)
        #return self.path
