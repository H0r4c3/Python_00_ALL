...
if __name__ == '__main__':
    path = r'C:\Users\Horace.000\eclipse-workspace\Python_Project_6_Online_Courses\00_ALL\Files\Download_sequential_files\downloads'
    download_files('http://699340.youcanlearnit.net/image001.jpg', path)
