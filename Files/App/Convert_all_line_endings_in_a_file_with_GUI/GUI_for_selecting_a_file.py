...
from convert_all_line_endings_in_a_file import convert_line_endings

class CreateMenusFieldsButtons():

    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Select a File to work with it")
        ...
        self.path = r"C:\Users\Horace.000\eclipse-workspace\Python_Project_6_Online_Courses\00_ALL\Files\App\Convert_all_line_endings_in_a_file_with_GUI\Subtitle_NOK.srt"
    ...
    def method_for_button_START(self): 
        ...
        convert_line_endings(self.path)
