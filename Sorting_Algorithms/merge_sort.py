...
In the case of merge sort, the divide-and-conquer approach divides the set of input values into two equal-sized parts, 
...
if __name__ == "__main__":
    ...
    my_time = timeit.timeit("merge_sort(array)", number = 50_000, globals = globals())
