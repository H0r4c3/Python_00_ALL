...
class CreateMenusFieldsButtons():
    ...
    def method_for_button_Take_Screenshots(self): 
        ...
        path = r'C:\Users\Horace.000\eclipse-workspace\Python_Project_6_Online_Courses\04_udemy_Courses\__udemy_Learn_Python_With_20+_Real_World_Projects__\screenshots'
        name = path + '\{}.png'.format(name) 
        time.sleep(5)
