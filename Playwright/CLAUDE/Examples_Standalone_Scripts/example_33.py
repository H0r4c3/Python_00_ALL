...
with sync_playwright() as p:
    ...
    is_checked1 = page.locator("input[type='checkbox']").first.is_checked()
    print(f"First checkbox checked: {is_checked1}")
    is_checked2 = page.get_by_role("checkbox").nth(1).is_checked()
    print(f"Second checkbox checked: {is_checked2}")
    browser.close()
