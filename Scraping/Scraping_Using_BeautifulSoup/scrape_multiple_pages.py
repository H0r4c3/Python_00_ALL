...
for page_number in range(1,4):
    ...
    #url = r'C:\Users\Horace.000\eclipse-workspace\Python_Project_6_Online_Courses\00_ALL\Scraping\Scraping_Using_BeautifulSoup\Best Sellers _ Feedbooks_NEW.mhtml'
