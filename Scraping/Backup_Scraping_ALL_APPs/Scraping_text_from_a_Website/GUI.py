...
class CreateFieldsButtons():
    ...
    def __init__(self):
        self.window = tk.Tk()
        self.window.title("Scraping text from a website")
    ...
    def create_input_fields(self):
        ...
        default_path = 'https://www.thepythoncode.com/article/download-web-page-images-python'
        default_locator_paragraphs = 'div.container-fluid'
        default_locator_details = 'div.row'
        ...
        #default_locator_paragraphs = 'body > div.page-wrap > section > div'
        #default_locator_details = 'body > div.page-wrap > section > div > div'
        ...
        self.field1_entry = ttk.Entry(self.frame1, width=200, textvariable = self.input_field1, font=('arial', 10, 'normal')) 
        ...
        self.field2_entry=ttk.Entry(self.frame2, width=200, textvariable = self.input_field2, font = ('arial', 10,'normal'))
        ...
        self.field3_entry=ttk.Entry(self.frame3, width=200, textvariable = self.input_field3, font = ('arial', 10,'normal'))
    ...
    def create_text_widget(self, text):
    ...
    def scraping_when_button_clicked(self):
        ...
        allparagraphsparsed = paragraphs_object.allparagraphs # a list of 1 string

        print(allparagraphsparsed[0]) # the string from the list

        messages_string = allparagraphsparsed[0]

        self.create_text_widget(messages_string)
...
def message_box(self, messages_string):
    ...
    my_text = tk.Label(my_frame1, text=messages_string, font="Arial 14")
    my_text.grid(row=0, column=0, padx=20)
