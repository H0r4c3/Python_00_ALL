...
def message_box(self, messages_string):
    ...
    pic_geaca = PhotoImage(file=r"c:\Users\Horace.000\eclipse-workspace\Python_Project_6_Online_Courses\0_ALL\Scraping\Scraping_ReadyToWear\GBTroon_2_SF_LACAV_NavyOffWhite_(1)-470x470.png ")
