...
class CreateFieldsButtons():
    ...
    def create_input_fields(self):
        ...
        default_locator_paragraphs = 'div.product--detail-upper.block-group'
        default_locator_details = 'div.product--buybox.block'
    ...
    def scraping_when_button_clicked(self):
        ...
        paragraphs_object = AllParagraphsForParsing(page_content, PARAGRAPHS_locator)
        ...
        if DETAIL_locator != '':
            details_list = [ParserDetails(item, DETAIL_locator) for item in allparagraphsparsed]
            print(details_list)
            self.fill_text_widget(details_list)
        else:
            print(allparagraphsparsed)
            self.fill_text_widget(allparagraphsparsed)
