...
class CreateFieldsButtons():
    ...
    def __init__(self):
        self.window = tk.Tk()
        self.window.title("Geaca Gipsy - ReadyToWear.ro")
    ...
    def create_input_fields(self):
        ...
        default_path1 = 'https://www.readytowear.ro/barbati/imbracaminte/geci/geci-de-piele-barbati/geaca-de-piele-naturala-barbati-gipsy-bleumarin-alb-murdar/'
        default_path2 = 'https://www.readytowear.ro/barbati/imbracaminte/geci/geci-de-piele-barbati/geaca-de-piele-naturala-barbati-gipsy-bleumarin-alb-murdar-gbtroon-2-sf-lacav'
        ...
        self.field1_entry = ttk.Entry(self.frame1, width=150, textvariable = self.input_field1, font=('arial', 10, 'normal')) 
        # default value for input field 1
        self.field1_entry.insert(tk.END, default_path2)
        ...
        self.field2_entry=ttk.Entry(self.frame2, width=150, textvariable = self.input_field2, font = ('arial', 10,'normal'))
        ...
        self.field3_entry=ttk.Entry(self.frame3, width=150, textvariable = self.input_field3, font = ('arial', 10,'normal'))
    ...
    def scraping_when_button_clicked(self):
        #path1 = 'https://www.readytowear.ro/barbati/imbracaminte/geci/geci-de-piele-barbati/geaca-de-piele-naturala-barbati-gipsy-bleumarin-alb-murdar'
        path2 = 'https://www.readytowear.ro/barbati/imbracaminte/geci/geci-de-piele-barbati/geaca-de-piele-naturala-barbati-gipsy-bleumarin-alb-murdar-gbtroon-2-sf-lacav'
        #path = 'https://books.toscrape.com/'
        allparagraphsparsed = []
        global messages_string
        messages_string = ''
        ...
        allparagraphsparsed = paragraphs_object.allparagraphs

        for item in (allparagraphsparsed[0].detail):
            messages_string = messages_string + item + '\n'
            print(item)
         
        #msg = messagebox.showinfo("Geaca Gipsy", messages_string)

        # create a message box Toplevel
        message_box(self, messages_string)
        


def message_box(self, messages_string):
    top = Toplevel(self.window)
        
    top.geometry("700x500")
    top.config(bg="blue")

    pic_geaca = PhotoImage(file=r"C:\Users\Horace.000\eclipse-workspace\Python_Project_6_Online_Courses\00_ALL\Scraping\Scraping_ReadyToWear\GBTroon_2_SF_LACAV_NavyOffWhite_(1)-470x470.png")

    my_frame1 = tk.Frame(top, bg="blue")
    my_frame1.pack(pady=5)
    pic = tk.Label(my_frame1, image=pic_geaca)
    pic.grid(row=0, column=0, padx=10) 

    my_frame2 = tk.Frame(top, bg="yellow")
    my_frame2.pack(pady=5)
    my_text = tk.Label(my_frame2, text=messages_string, font="Arial 14")
    my_text.grid(row=1, column=0, padx=20)
