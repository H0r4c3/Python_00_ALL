...
def main():
    ...
    # Converting to excel 
    df.to_excel('c:/Users/Horace.000/eclipse-workspace/Python_Project_6_Online_Courses/00_ALL/Scraping/YTS_YIFY/YIFY_torrents.xlsx', index = True, header=True, sheet_name = 'Popular Movies')
